...
from theblog.models import Profile,Like,Post
...
class ShowProfilePageView(DetailView):
	...
	#def total_likes_received(self):
		##total_likes_received = Like.objects.filter(post__author=post.likes).count()
	...
	def get_context_data(self, *args, **kwargs):
		...
		like_count = get_object_or_404(Profile, id=self.kwargs['pk'])
